    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative bg-surface-container border border-outline-variant/20 w-full max-w-sm mx-4 flex flex-col">
        ...
        <div className="px-6 py-5 border-b border-outline-variant/20">
          <h2 className="text-headline-md font-bold text-on-surface">Eliminar Producto</h2>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-body-md text-on-surface">
                ...
                <span className="font-bold text-primary">"{product.nombre}"</span>?
              </p>
              <p className="text-label-sm font-label-sm text-on-surface-variant/60 mt-2">
                Se eliminará el producto del menú. Esta acción no se puede deshacer.
              </p>
            </div>
          </div>
        </div>
